...
export default function PdfPage({ config, embedded = false }: { config: PdfPageConfig; embedded?: boolean }) {
    ...
    const pdfSource = `${config.source}#toolbar=1&navpanes=0`;
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto aspect-[210/297] w-full max-w-[52rem] overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                <object
                    data={pdfSource}
