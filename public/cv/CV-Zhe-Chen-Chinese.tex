...
\newcommand{\scholarstats}{\href{https://scholar.google.com/citations?user=2qgIJwwAAAAJ}{\scholaricon\hspace{0.25em}\textcolor{darkblue}{谷歌学术}}被引：2,400；h-index：19；热点论文：1；高被引论文：2}
...
\fancyfoot[L]{\footnotesize\textcolor{white}{最近更新：2026年9月15日}}
...
期刊评审 & \justifying\arraybackslash\setlength{\parindent}{0pt}\itshape Advanced Engineering Informatics, Applied Energy, Applied Thermal Engineering, Automation in Construction, Building and Environment, Building Simulation, Computers in Industry, Energy, Energy and Buildings, Energy Conversion and Management, Engineering Applications of Artificial Intelligence, IEEE Transactions on Smart Grid, Journal of Cleaner Production, Sustainable Cities and Society \cvtabrowgap
协会会员 & 国际建筑性能模拟协会\newline（International Building Performance Simulation Association, IBPSA）\newline
            国际能源与建筑环境学会\newline（International Society of Energy and Built Environment, ISEBE） \\
\end{tabularx}
